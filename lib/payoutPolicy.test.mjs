...
test("cancellation automatically follows the frozen policy and deadline", () => {
  const start = "2026-09-10T12:00:00.000Z";
  assert.equal(shouldRefundCancellation("moderate", start, 48, "2026-09-08T11:59:59.000Z"), true);
  assert.equal(shouldRefundCancellation("moderate", start, 48, "2026-09-08T12:00:00.000Z"), true);
  assert.equal(shouldRefundCancellation("moderate", start, 48, "2026-09-08T12:00:01.000Z"), false);
  assert.equal(shouldRefundCancellation("non_refundable", start, null, "2026-09-01T12:00:00.000Z"), false);
});
