...
test("no-refund clients may only reschedule strictly before 24 hours", () => {
  assert.deepEqual(clientAppointmentPermissions("non_refundable", start, "2026-09-09T11:59:59.999Z"), {
    canReschedule: true,
    canCancel: false,
    message: "Vous pouvez déplacer votre rendez-vous jusqu’à 24 h avant.",
  });
  assert.equal(clientAppointmentPermissions("non_refundable", start, "2026-09-09T12:00:00.000Z").canReschedule, false);
});
